...
class LspShowScopeNameCommand(LspTextCommand):
    ...
    def _render_with_plain_string_stackframes(self, scope: str, scope_list: str, stack: list[str], semantic_info: SemanticTokensInfo) -> None: ...
    def _render_with_fancy_stackframes(self, scope: str, scope_list: str, stack: list[Any], semantic_info: SemanticTokensInfo) -> None: ...
    def _show_popup(self, digits_len: int, scope: str, scope_list: str, backtrace: str, semantic_info: SemanticTokensInfo, on_navigate: Callable[[str], None]) -> None: ...
